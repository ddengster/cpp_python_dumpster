...
#create_cloud('cloud_blei_lda.png', words) #deprecated
#https://stackoverflow.com/questions/52464932/how-do-i-save-word-cloud-as-png-in-python

#cloud = WordCloud().generate(words_slice)
cloud = WordCloud().fit_words(words_dict)
cloud.to_file('cloud_blei_lda.png')
