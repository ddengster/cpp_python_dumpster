...
private:
	...
	ProfileData(void)
		: timeTaken(0), minimum(UINT32_MAX), maximum(0), instancesCount(0), timesCalledPerFrame(0), numOfParents(0), isValid(true) {}

	Real timeTaken, minimum, maximum;											//Time related parameter
	uint32_t instancesCount, timesCalledPerFrame;								//Number of calls
	uint32_t numOfParents;														//Number of Parents
